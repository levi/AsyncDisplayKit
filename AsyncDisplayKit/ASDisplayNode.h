 ...
 */
typedef void (^ASDisplayNodeDidLoadBlock)(ASDisplayNode * _Nullable node);
 ...
 */
- (nullable instancetype)initWithViewBlock:(ASDisplayNodeViewBlock)viewBlock;
 ...
 * queue. The view will render synchronously and -layout and touch handling methods on the node will not be called.
 */
- (nullable instancetype)initWithViewBlock:(ASDisplayNodeViewBlock)viewBlock didLoadBlock:(nullable ASDisplayNodeDidLoadBlock)didLoadBlock;
 ...
 */
- (nullable instancetype)initWithLayerBlock:(ASDisplayNodeLayerBlock)layerBlock;
 ...
 * queue. The layer will render synchronously and -layout and touch handling methods on the node will not be called.
 */
- (nullable instancetype)initWithLayerBlock:(ASDisplayNodeLayerBlock)layerBlock didLoadBlock:(nullable ASDisplayNodeDidLoadBlock)didLoadBlock;
 ...
 * well.
 */
@property (nonatomic, readonly, retain, nullable) UIView *view;
 ...
 * well.
 */
@property (nonatomic, readonly, retain, nullable) CALayer *layer;
 ...
 * @see [ASDisplayNode(Subclassing) calculateLayoutThatFits:]
 */
- (nullable ASLayout *)measureWithSizeRange:(ASSizeRange)constrainedSize;
 ...
 */
@property (nonatomic, readonly, retain, nullable) NSArray<ASDisplayNode *> *subnodes;
...
- (BOOL)canPerformAction:(nullable SEL)action withSender:(nullable id)sender;
...
@property (atomic, copy, nullable)    NSString *accessibilityLabel;
@property (atomic, copy, nullable)    NSString *accessibilityHint;
@property (atomic, copy, nullable)    NSString *accessibilityValue;
@property (atomic, assign)            UIAccessibilityTraits accessibilityTraits;
@property (atomic, assign)            CGRect accessibilityFrame;
@property (atomic, retain, nullable)  NSString *accessibilityLanguage;
